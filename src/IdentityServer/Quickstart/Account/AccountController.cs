    ...
    public class AccountController : Controller
    {
        ...
        public async Task<IActionResult> Login(LoginInputModel model, string button)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                //if (result.Succeeded)
                ////if ((await _signInManager.CheckPasswordSignInAsync(new ApplicationUser() { UserName = model.Username }, model.Password, true)).Succeeded)
                //{
        ...
        public async Task<IActionResult> Register(RegisterVM model)
        {
            if (ModelState.IsValid)
            {
                ...
                user = new ApplicationUser
                {
                    ...
                    Email = model.Email,
                    ArabicFirstName = model.ArabicFirstName,
                    ArabicMiddleName = model.ArabicMiddleName,
                    ArabicFamilyName = model.ArabicFamilyName,
                    ArabicGrandName = model.ArabicGrandName,
                    EnglishFirstName = model.EnglishFirstName,
                    EnglishMiddleName = model.EnglishMiddleName,
                    EnglishGrandName = model.EnglishGrandName,
                    EnglishFamilyName = model.EnglishFamilyName,
